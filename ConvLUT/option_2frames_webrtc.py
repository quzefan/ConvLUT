...
def set_args():
    ...
    parser.add_argument('--bps', type=str,
                            default='100Kbps')
    #checkpoint
    parser.add_argument('--sing', type=str2bool,
                        default=True)
    parser.add_argument('--lut_tables_path', type=str,
                        default='/SRResNet_webrtc_LUT_tables/')
    parser.add_argument('--triangular_index_path', type=str,
                        default='/triangular_index.npy')
    parser.add_argument('--checkpoint_dir', type=str,
                        default='/checkpoint_webrtc')
    # parser.add_argument('--lut_tables_path', type=str,
    #                     default='/home/v-gyin/github/VSR_LUT_hidden/SRResNet_webrtc_LUT_tables/')
    # parser.add_argument('--checkpoint_dir', type=str,
    #                     default='/home/v-gyin/github/VSR_LUT_hidden/checkpoint_pixel_w_b_two_frames')

    args = parser.parse_args()
    if args.sing:
        data_root_path = '.'
        args.lut_tables_path = '.' + args.lut_tables_path
        args.triangular_index_path = '.' + args.triangular_index_path
        # args.checkpoint_dir = '.' + args.checkpoint_dir
    else:
        data_root_path = '/home/v-gyin'
        args.lut_tables_path = '/home/v-gyin/github/VSR_LUT_main' + args.lut_tables_path
        args.triangular_index_path = '/home/v-gyin/github/VSR_LUT_main' + args.triangular_index_path
        args.checkpoint_dir = '/home/v-gyin/github/VSR_LUT_main' + args.checkpoint_dir
    
    args.train_hr_file_path = data_root_path + "/dataset/{}/Orig/train_down4_png/".format(args.bps)
    args.train_lr_file_path = data_root_path + "/dataset/{}/Client/train_down4_png/".format(args.bps)
    args.train_lr_mv_file_path = data_root_path + "/dataset/{}/Client/train_down4_mv_png/".format(args.bps)
    
    args.val_hr_file_path = data_root_path + "/dataset/{}/Orig/track3_val_png/".format(args.bps)
    args.val_lr_file_path = data_root_path + "/dataset/{}/Client/track3_val_png/".format(args.bps)
    args.val_lr_mv_file_path = data_root_path + "/dataset/{}/Client/track3_val_mv_png/".format(args.bps)
    
    args.test_hr_file_path = data_root_path + "/dataset/{}/Orig/track3_test_png/".format(args.bps)
    args.test_lr_file_path = data_root_path + "/dataset/{}/Client/track3_test_png/".format(args.bps)
    args.test_lr_mv_file_path = data_root_path + "/dataset/{}/Client/track3_test_mv_png/".format(args.bps)
